...
//#define MB_MAX_VOLTAGE ((MB_DIVIDER_R1 + MB_DIVIDER_R2) * MB_ADC_VOLTAGE) / MB_DIVIDER_R2
	...
	private:
	char _temperature[2] = { 0, 0 };	// generated temperature bytes for telemetry out.
	char _t_voltage = 0;				// generated byte for telemetry output
...
//		packet_length = sprintf_P(packet_buffer, PSTR("aaa"),0);
		_packet_length = sprintf_P(_packet_buffer, PSTR("T#MIC%03u,%03u,%03u,%03u,%03u,"),
				this->_t_voltage, this->_temperature[0], this->_temperature[1], 0, 0);
